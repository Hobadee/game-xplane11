...
// We will use this file in the root of the package to determine what type of plugin we are
const OPTIONS_FILE = 'XPModInfo';
const OPTIONS_FILE_TYPE_KEY = 'type';
const OPTIONS_FILE_TYPE_AIRCRAFT = 'AIRCRAFT';
const OPTIONS_FILE_TYPE_PLUGIN = 'PLUGIN';
const OPTIONS_FILE_TYPE_SCENERY = 'SCENERY';


// # Files and directories
const AIRCRAFT_SUBDIR = 'Aircraft';
const PLUGINS_SUBDIR = 'Resources\plugins';  // This likely won't work!!!
const SCENERY_SUBDIR = 'Custom Scenery';
 ...
 *
 * This function registers the game extension and it's methods with Vortex
 */
...
function installScenery(files) {
	/*
	 * Note that when we install scenery, we will need to edit the "scenery_packs.ini" file.
	 *
	 * Scenery load order: (Should be listed in the INI in this order)
	 * 1. Airports
	 * 2. Overlay Sceneries (eg. World2XPlane, OSM2XP, Tree Lines and Farms)
	 * 3. MESH and Photo Sceneries
	 * 
	 * If X-Plane detects new scenery, it will be auto-added to the TOP of the list
	 * alphabetically.  This is bad if we are adding a Photo Scenery, for example.  We also
	 * can't rely on removing the file and having it re-generated by X-Plane as alpha-sort
	 * won't help us either.
	 * 
	 * More details on everything may be found here:
	 * https://www.x-plained.com/scenery_pack-ini-file/
	 */
}
